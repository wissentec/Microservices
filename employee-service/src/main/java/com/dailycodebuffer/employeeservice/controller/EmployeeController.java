...
import com.dailycodebuffer.employeeservice.config.DepertmentFeignClient;
...
public class EmployeeController {
    ...
    @Autowired
    DepertmentFeignClient feignclient;
    ...
    public List<Department> getDepartment() {
        LOGGER.info("Employee get depertments");
        return feignclient.getDepertment();
    }
